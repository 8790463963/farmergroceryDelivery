...
mongoClient.connect("mongodb+srv://admin:MIU6EZDGk5ydBvtR@navyacluster.kk3d3xp.mongodb.net/?retryWrites=true&w=majority&appName=navyacluster")
.then(dbRef=>{
    //Connect to database
    ...
    console.log(`database server listening...`)
